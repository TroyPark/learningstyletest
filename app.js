...
const results = {
    ...
    INTP: {
        ...
        methods: [
            ...
            "친구와 토론하며 이해도 점검하기",
            "<strong>1:1 맞춤 학습</strong>으로 실천력 향상 및 문제 풀이 습관 만들기"
        ]
    },
    ENTJ: {
        emoji: "👑",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 효율적인 시간 관리 및 전략 최적화하기"
        ]
    },
    ENTP: {
        emoji: "🎪",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 집중력 관리 및 체계적인 학습 진행하기"
        ]
    },
    INFJ: {
        emoji: "🌙",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 스트레스 관리 및 학습 페이스 조절하기"
        ]
    },
    INFP: {
        emoji: "🌸",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 동기부여 및 흥미 유발 맞춤 학습하기"
        ]
    },
    ENFJ: {
        emoji: "✨",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 자신만의 학습 시간 확보 및 집중하기"
        ]
    },
    ENFP: {
        emoji: "🎨",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 재미있는 학습 방법 찾고 끈기 키우기"
        ]
    },
    ISTJ: {
        emoji: "📚",
        ...
        methods: [
            ...
            "체크리스트 만들어 하나씩 완료하기",
            "가끔은 새로운 방법도 시도해보기",
            "<strong>1:1 맞춤 학습</strong>으로 체계적인 커리큘럼 구성 및 진도 관리하기"
        ]
    },
    ISFJ: {
        emoji: "📖",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 효율적인 정리법 및 시간 배분 연습하기"
        ]
    },
    ESTJ: {
        emoji: "⏰",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 정확한 목표 설정 및 실전 훈련하기"
        ]
    },
    ESFJ: {
        emoji: "🤗",
        ...
        methods: [
            ...
            "<strong>1:1 맞춤 학습</strong>으로 나만의 학습 환경 만들고 실력 키우기"
        ]
    },
    ISTP: {
        emoji: "🔧",
        ...
        methods: [
            ...
            "손으로 직접 풀면서 감 익히기",
            "개념도 한 번씩은 짚고 넘어가기",
            "<strong>1:1 맞춤 학습</strong>으로 개념 이해 강화 및 응용력 키우기"
        ]
    },
    ISFP: {
        emoji: "🎵",
        ...
        methods: [
            ...
            "움직이면서 공부하기 (산책하며 암송)",
            "논리적 구조도 함께 이해하기",
            "<strong>1:1 맞춤 학습</strong>으로 창의적 학습법 개발 및 논리력 보완하기"
        ]
    },
    ESTP: {
        emoji: "⚡",
        ...
        methods: [
            ...
            "움직이면서 공부하기 (서서 하기 등)",
            "계획적인 복습으로 장기 기억 만들기",
            "<strong>1:1 맞춤 학습</strong>으로 체계적인 복습 습관 및 기초 다지기"
        ]
    },
    ESFP: {
        emoji: "🎉",
        ...
        methods: [
            ...
            "조금씩이라도 매일 하는 습관 들이기",
            "<strong>1:1 맞춤 학습</strong>으로 흥미 유지 및 꾸준한 학습 습관 만들기"
        ]
    }
};
